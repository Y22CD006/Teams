        ...
        {messages.map((msg, index) => {
          ...
          return (
            <div
              ...
              className={`group flex gap-3 px-4 py-1.5 transition-colors relative ${showHeader ? 'mt-3' : 'mt-0.5'} ${isMe ? 'justify-end' : 'justify-start'}`}
            >
              {/* Sender Avatar (Hidden for current user like iMessage) */}
              {!isMe && (
                <div className="flex-shrink-0 w-9 pt-1 flex justify-center">
                  {showHeader ? (
